...
//		}
    ...
    protected function short_description( $product ) {
        ...
        //strip tags and spacial characters
        return wp_strip_all_tags(wp_specialchars_decode($short_description));
    }
    ...
    protected function current_price( $product ) {
        if ( $product->is_type('variable') ) {
            ...
            return $this->getBundleProductPrice( $product, 'price' );
        }else {
    ...
    protected function sale_price( $product ) {
        if ( $product->is_type('variable') ) {
            ...
            return $this->getBundleProductPrice( $product, 'sale_price' );
        } else {
