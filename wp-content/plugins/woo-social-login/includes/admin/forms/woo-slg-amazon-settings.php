		...
		<div class="meta-box-sortables ui-sortable">
			<div id="amazon" class="postbox">
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<h3 class="hndle">
						<span style='vertical-align: top;'><?php esc_html_e( 'Amazon Settings', 'wooslg' ); ?></span>
					</h3>
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<span class="description"><?php echo esc_html__( 'Before you can start using Amazon for the social login, you need to create a Amazon Application. You can get a step by step tutorial on how to create Amazon Application on our', 'wooslg' ) . ' <a target="_blank" href="http://wpweb.co.in/documents/social-network-integration/amazon/">' . esc_html__( 'Documentation', 'wooslg' ) . '</a>'; ?></span>
								</td>
							</tr>
