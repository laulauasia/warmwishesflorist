		...
		<div class="meta-box-sortables ui-sortable">
			<div id="facebook" class="postbox">
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<h3 class="hndle">
						<span style='vertical-align: top;'><?php esc_html_e( 'Facebook Settings', 'wooslg' ); ?></span>
					</h3>
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<span class="description"><?php echo esc_html__( 'Before you can start using Facebook for the social login, you need to create a Facebook Application. You can get a step by step tutorial on how to create Facebook Application on our', 'wooslg' ) . ' <a target="_blank" href="http://wpweb.co.in/documents/social-network-integration/facebook/">'. esc_html__( 'Documentation', 'wooslg' ). '</a>'; ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'Enter Facebook API Key.', 'wooslg'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'Enter Facebook App Secret.', 'wooslg'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo '<br />'. esc_html__(  'Select the language for Facebook. With this option, you can explicitly tell which language you want to use for communicating with Facebook.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'If you want to use your own Facebook Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<input type="button" class="woo-slg-upload-file-button button-secondary" value="<?php esc_html_e( 'Upload File', 'wooslg' );?>"/></br>
									<span class="description"><?php echo esc_html__( 'If you want to use your own Facebook Link Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'If you want to use your own Facebook Text, Enter here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'If you want to use your own Facebook Link Text, enter here.', 'wooslg' ); ?></span>
								</td>
							</tr>
