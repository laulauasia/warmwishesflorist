		...
		<div class="meta-box-sortables ui-sortable">
			<div id="misc" class="postbox">
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<h3 class="hndle">
						<span style='vertical-align: top;'><?php esc_html_e( 'Misc Settings', 'wooslg' ); ?></span>
					</h3>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<span class="description"><label for="woo_slg_delete_options"><?php echo esc_html__( 'If you don\'t want to use the Social Login Plugin on your site anymore, you can check that box. This makes sure, that all the settings and tables are being deleted from the database when you deactivate the plugin.','wooslg' ); ?></label></span>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="checkbox" id="woo_slg_public_js_unique_version" name="woo_slg_public_js_unique_version" value="1" <?php echo ($woo_slg_public_js_unique_version =='yes') ? 'checked="checked"' : ''; ?>/></br>
									<span class="description"><label for="woo_slg_public_js_unique_version"><?php echo esc_html__( 'Check this box, if you use a caching plugin','wooslg' ); ?></label></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<a class="button" href="<?php echo add_query_arg(array( 'woo_slg_gen_sys_log' => '1')); ?>" ><?php echo esc_html__( 'Generate System Report', 'wooslg' ); ?></a></br>
									<span class="description"><?php echo esc_html__( 'Please generate system report file and provide us in your ticket when contacting support.','wooslg' ); ?></span>
								</td>
							</tr>
