			...
			<tbody>
				...
				?>
					<tr class="<?php print $drag_class;?>">
						...
						?>
						<td style="<?php print $email_style;?>"><a href="<?php echo esc_url($redirect_uri); ?>" class="button"><?php esc_html_e('Settings', 'wooslg'); ?></a></td>
						<?php
							//do action to add social table data reg count after
	...
	<script type="text/javascript">
      ...
      function WooSlgDrawChart() {
	        ...
	        var deals_social_chart_options = {
	        				'title':'<?php esc_html_e('Social Networks Register Percentage', 'wooslg'); ?>',
	                       	'width':'auto',
	                       	'height':450
	        			}; 
