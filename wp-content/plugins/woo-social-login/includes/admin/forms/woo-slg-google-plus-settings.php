		...
		<div class="meta-box-sortables ui-sortable">
			<div id="google_plus" class="postbox">
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<h3 class="hndle">
						<span style='vertical-align: top;'><?php esc_html_e( 'Google Settings', 'wooslg' ); ?></span>
					</h3>
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<span class="description"><?php echo esc_html__( 'Before you can start using Google for the social login, you need to create a Google Application. You can get a step by step tutorial on how to create Google Application on our', 'wooslg' ) . ' <a target="_blank" href="http://wpweb.co.in/documents/social-network-integration/google/">' . esc_html__( 'Documentation', 'wooslg' ) . '</a>'; ?></span>
								</td>
							</tr>
							...
							<tr>
								<td colspan="4">
									<p class="woo-slg-error-box"><?php echo sprintf(esc_html__( 'Note: Before using the Google social login, update the %s Authorized JavaScript origins %s in Google App setting, as mentioned in the document', 'wooslg' ), "<strong>", "</strong>"); ?> <a href="https://wpweb.co.in/documents/social-network-integration/google/#google-javascript-origins" target="_blank"><?php echo esc_html__( 'here', 'wooslg' ); ?></a>.</p>
								</td>
							</tr>
