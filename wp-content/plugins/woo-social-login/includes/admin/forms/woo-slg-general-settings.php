	...
	<div class="metabox-holder">
		<div class="meta-box-sortables ui-sortable">
			...
			<div class="postbox">
				...
				<h3 class="hndle">
					<span style='vertical-align: top;'><?php esc_html_e( 'General Settings', 'wooslg' ); ?></span>
				</h3>
			...
			<div class="postbox">
				...
				<!-- general settings box title -->
				<h3 class="hndle">
					<span style='vertical-align: top;'><?php esc_html_e( 'Display Settings', 'wooslg' ); ?></span>
				</h3>
						...
						<tbody>
							...
							<tr id="woo-slg-social-btn-hooks-container" style="<?php print $woo_slg_social_hooks_container;?>">
								...
								<td>
									...
									<br>
									<span class="description"><?php echo sprintf(esc_html__( 'You can find more information about using hook in the %s manual %s.', 'wooslg' ), '<a href="https://wpweb.co.in/documents/woocommerce-social-login/social-login-setup-docs/#using-custom-hooks" target="_blank">', '</a>'); ?></span>
									<br><br>
