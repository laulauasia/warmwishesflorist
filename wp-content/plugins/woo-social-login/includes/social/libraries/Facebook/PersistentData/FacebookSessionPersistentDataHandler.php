...
class FacebookSessionPersistentDataHandler implements PersistentDataInterface
{
    ...
    public function get($key)
    {
        ...
        $data = get_site_transient($this->sessionPrefix . $key);

        if ( !empty( $data )  ) { // added by wpweb

            
            return $data; // added by wpweb
        }
    ...
    {   
        ...
        set_site_transient( $this->sessionPrefix . $key, $value, 3600);
    }
}
