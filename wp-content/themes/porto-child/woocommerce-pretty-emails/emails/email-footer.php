...
?>
            ...
            <div class="footer" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; width: 100%; clear: both; color: #666; margin: 0; padding: 0;">
                <table width="100%" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; margin: 0; padding: 0;">
                    ...
                    <td class="alignleft quarter" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; vertical-align: middle; width: 25%; margin: 0; padding: 10px 0;" valign="middle" width="25%">
                   ...
                   <?php
                    ...
                    <td class="aligncenter half" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 11px; color: <?php echo $text;?>; vertical-align: middle; text-align: center; width: 50%; margin: 0; padding: 10px 0; line-height: 1.2;" align="center" valign="middle" width="50%">
                    
                        <?php echo wpautop( wp_kses_post( wptexturize( apply_filters( 'woocommerce_email_footer_text', get_option( 'woocommerce_email_footer_text' ) ) ) ) ); ?>
              
                    </td>
                    
                    <td class="alignright quarter" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; vertical-align: middle; text-align: right; width: 25%; margin: 0; padding: 10px 0;" align="right" valign="middle" width="25%">
