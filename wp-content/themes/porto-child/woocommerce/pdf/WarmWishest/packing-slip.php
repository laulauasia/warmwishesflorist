...
<table class="order-data-addresses">
	<tr>
		<td class="address shipping-address">
			...
			<div class="shipping-address"><?php $wpo_wcpdf->shipping_address(); ?></div>
			<?php $wpo_wcpdf->custom_field('shipping_contact', '',  true); ?>
...
<table class="delivery-message"> 
	<tbody>
		<tr>
			<td class="delivery-message">&nbsp;</td>
		</tr>
		<tr>
			<td class="delivery-message">
			<p style="text-align: center;">
			<?php echo get_post_meta($wpo_wcpdf->export->order->id,'recipient',true); ?>
			<p>&nbsp;</p>
			<p style="text-align: center;">
			<?php echo get_post_meta($wpo_wcpdf->export->order->id,'special_message',true); ?>
			<p>&nbsp;</p>
			<p style="text-align: center;">
			<?php echo get_post_meta($wpo_wcpdf->export->order->id,'sender',true); ?>
			</p>
			</td>
		</tr>
	</tbody>
