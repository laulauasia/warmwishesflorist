...
<table class="order-data-addresses">
	<tr>
		<td class="address shipping-address">
			<h3><?php _e( 'Recipient Address:', 'wpo_wcpdf' ); ?></h3>
			...
			<h3><?php _e( 'Recipient Phone:', 'wpo_wcpdf' ); ?></h3>
			<?php $wpo_wcpdf->custom_field('shipping_contact', ''); ?>
			
			<?php } ?>
			<h3><?php _e( 'Message on the Card:', 'wpo_wcpdf' ); ?></h3>
		...
		<td class="order-data">
			<table>
				...
				<tr>
				<?php $wpo_wcpdf->custom_field('jckwds_date', 'Pickup/Delivery Date: '); ?>
				</tr>
